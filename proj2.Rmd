...
```{r lr_smr,fig.cap="Summary of logistic regression model",out.width="70%",echo=FALSE}
knitr::include_graphics("plot/lr_smr.png") 
```

```{r lr_coef,fig.cap="Coefficients of logistic regression model",out.width="70%",echo=FALSE}
knitr::include_graphics("plot/lr_coef.png") 
```

```{r lr_linearity,fig.cap="Linearity test for logistic regression model",out.width="70%",echo=FALSE}
knitr::include_graphics("plot/lr_linearity.png") 
```

```{r lr_collinearity,fig.cap="Collinearity test for logistic regression model",out.width="70%",echo=FALSE}
knitr::include_graphics("plot/lr_collinearity.png") 
```

```{r lr_pca,fig.cap="PCA for logistic regression model",out.width="70%",echo=FALSE}
